...
::: {.fragment .incremental .fade-in style="font-size: 80%;"}
- DB relazionali: 
   - Scalbilità verticale ottima: aggiunggendo risorse ad un singolo nodo si ottengono buone performance.
...
- ***Consistenza***:  (***C*** - Consistency) tutti i nodi hanno la stessa copia dei dati in ogni momento.
  ...
  - Qualsiasi sia il server che risponde ad una richiesta, oterrò la medesima risposta.
:::
...
- Offrre perfornamce simili al RAID 0 con la ridondanza del RAID 1
:::
::::
:::
...
La ***replica*** è la creazione di copie identiche dei dati su diversi disposiivi di storage
:::
:::
...
Non è una tecnologia specifica, ma una proprietà emergente di un un sistema che incorpora replica e ridondanza.
:::
:::
...
In generale si addossala responsabilità di prevenire data losses all'utente finale, il che non è mai una buona idea.
:::
...
- Il server espone un file system montato dai client, nulla di più
:::
