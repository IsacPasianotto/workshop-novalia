...
::: {.fragment .fade-in style="font-size: 80%;"}
Che cosa mi dice questo dato?
:::

::: {.fragment .fade-in style="font-size: 80%;"}
| Rappresentazione | Valore     |
|------------------|------------|
| Naturale (uint16)| 48,188     |
| Intero (int16)   | -15,420    |
| Float16 (FP16)   | -0.0588    |
| Esadecimale      | BC3C      |
| UTF-8 (2 char)   | ¼<         |
...
- La differenza è che **i dati sono memorizzati nella memoria principale (RAM)** anziché su archiviazione
...
- Requirements:
  ...
  - Feature di backup e restore disponibili anche nelle versioni open-source
:::
...
La struttura logica di un file system è generalmente ad albero o a grafo, con directory (cartelle) che contengono file e altre directory.
...
*Non tutti i file system sono uguali!* Alcuni presentano più o meno features che possono essere auspicabili, per esempio: COW (Copy On Write), journaling, snapshot, deduplica, compressione, crittografia, supporto a grandi file e volumi, ... 
:::
:::
